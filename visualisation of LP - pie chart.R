...
nonredundant_significant_features<-as.data.frame(rownames(back))
colnames(nonredundant_significant_features)<-"features"
...
PieDonut(pie_3,aes(pies= feature_org , donuts =  feature_location))
